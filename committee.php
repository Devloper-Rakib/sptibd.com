...
<body>
                        ...
                        <li class="nav-item dropdown myitem">
                            ...
                            <div class="dropdown-menu mydropdown">
                                ...
                                <a class="dropdown-item" target="_blank"
                                    href="http://www.bteb.gov.bd/site/page/14fc21a0-8a2d-400f-8e20-5fbd989a68f5/%E0%A6%8F%E0%A6%95%E0%A6%BE%E0%A6%A1%E0%A7%87%E0%A6%AE%E0%A6%BF%E0%A6%95-%E0%A6%95%E0%A7%8D%E0%A6%AF%E0%A6%BE%E0%A6%B2%E0%A7%87%E0%A6%A8%E0%A7%8D%E0%A6%A1%E0%A6%BE%E0%A6%B0">Calander</a>
                            </div>
                        </li>
                        <li class=" nav-item dropdown myitem">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
                    <marquee scrollamount="8" scrolldelay="5" direction="left" onmouseover="this.stop()"
                                ...
                                <div class="row justify-content-center g-2">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="card mb-3 rounded-0" style="max-width: 540px;">
                                            <div class="row g-0">
                                                <div class=" col-sm-12 col-md-12 col-lg-4 align-items-center">
                                                    <img src="image/staff/Shafiul Alam Chowdhury.jpg"
                                                        class="img-fluid" alt="image/staff/Shafiul Alam Chowdhury.jpg">
                                                </div>
                                                <div class=" col-sm-12 col-md-12 col-lg-8">
                                                    <div class="card-body">
                                                        <h5 class="card-title mb-1 text-uppercase">Shafiul Alam Chowdhury</h5>
                                                        <p class="card-text text-muted">Member of Parliament (MP)<br>
                                                        Moulvibazar-2</p>
                                                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. In ullam accusantium consequatur id aut, labore magnam praesentium, architecto harum nulla facere ducimus eum.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- committee: Director 1 -->
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <h5 class="title-bar">Director</h5>
                                        <div class="card mb-3 rounded-0" style="max-width: 540px;">
                                            <div class="row g-0">
                                                <div class=" col-sm-12 col-md-12 col-lg-4">
                                                    <img src="image/staff/Abul Kasem.jpg"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="card mb-3 rounded-0" style="max-width: 540px;">
                                            <div class="row g-0">
                                                <div class=" col-sm-12 col-md-12 col-lg-4">
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3HdBqVDU45zUIDYvJbH1QE2kosJ0VrH0KEXee3n33PnskjPbyvDAUWYrChTGjCXHA2cc&usqp=CAU"
                                                        class="img-fluid rounded-start" alt="...">
                                                </div>
                                                <div class=" col-sm-12 col-md-12 col-lg-8">
                                                    <div class="card-body">
                                    ...
                                    <!-- committee:  -->
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <h5 class="title-bar">No Data Found</h5>
                                        <div class="card mb-3 rounded-0" style="max-width: 540px;">
                                            <div class="row g-0">
                                                <div class=" col-sm-12 col-md-12 col-lg-4">
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3HdBqVDU45zUIDYvJbH1QE2kosJ0VrH0KEXee3n33PnskjPbyvDAUWYrChTGjCXHA2cc&usqp=CAU"
                    ...
                    <div class="card">
                        ...
                        <ul class="mylink list-group">
                            <li class="list-group-item"><i class="fas fa-angle-double-right"></i> <a
                                    href="http://www.bteb.gov.bd/ " target="_blank">Bangladesh Technical Education
                                    Board</a></li>
                            <li class="list-group-item"><i class="fas fa-angle-double-right"></i><a
                                    href="http://www.techedu.gov.bd/" target="_blank"> Directorate of Technical
                                    Education</a></li>
                            <li class="list-group-item"><i class="fas fa-angle-double-right"></i> <a
                                    href="http://www.tmed.gov.bd/" target="_blank">Technical and Madrasah Education
                                    Division</a></li>
                            <li class="list-group-item"><i class="fas fa-angle-double-right"></i> <a
                                    href="http://www.banbeis.gov.bd/" target="_blank">BANBEIS</a></li>
                            <li class="list-group-item"><i class="fas fa-angle-double-right"></i> <a
                                    href="http://btebadmission.gov.bd/" target="_blank">Diploma Admission</a></li>
